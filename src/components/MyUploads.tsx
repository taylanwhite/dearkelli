    ...
    <div className="space-y-4">
      <div className="text-center">
        ...
        <p className="mt-1 text-sm text-[var(--cream)]/45">
          Tap remove if something shouldn&apos;t be here.
        </p>
      </div>
      ...
      <ul className="grid grid-cols-2 gap-3">
        {items.map((item) => (
          ...
          >
            <div className="relative aspect-square bg-[var(--forest)]/20">
              {item.kind === "image" ? (
                ...
                <div className="flex h-full items-center justify-center px-3 text-center">
                  <span className="font-[family-name:var(--font-display)] text-lg text-[var(--gold)]">
                    Voice
                  </span>
                </div>
              )}
            ...
            <div className="flex items-center justify-between gap-2 px-3 py-2.5">
              <span className="truncate text-xs text-[var(--cream)]/55">
                {labelFor(item)}
              </span>
              <button
                type="button"
